...
package com.nitrogen.settings.fragments.ui;
...
public class AccentPicker extends InstrumentedDialogFragment implements OnClickListener {
    ...
    private void initView() {
        ...
        Button AccentNetfix = mView.findViewById(R.id.AccentNetflix);
        setAccent("29", AccentNetfix);

        Button AccentBubblegumPink = mView.findViewById(R.id.AccentBubblegumPink);
        setAccent("30", AccentBubblegumPink);

        Button AccentDarkIndigo = mView.findViewById(R.id.AccentDarkIndigo);
        setAccent("31", AccentDarkIndigo);

        Button AccentYandex = mView.findViewById(R.id.AccentYandex);
        setAccent("32", AccentYandex);
    }
